...
public class Desconto1 extends JPanel {
  ...
  public Desconto1() {
    _painel = new JPanel();
    _painel.setBorder(BorderFactory.createTitledBorder("Aplicar desconto % em um valor"));
    _painel.setLayout(null);
    _painel.setBounds(5, 5, 300, 150);

    LabelTextFieldBuilder labelTextFieldBuilder = new LabelTextFieldBuilder("Valor inicial R$ (a)", 25, 20);
    labelTextFieldBuilder.Build(_painel);

    LabelTextFieldBuilder labelTextField2Builder = new LabelTextFieldBuilder("% Desconto (b)", 25, 50);
    labelTextField2Builder.Build(_painel);

    LabelTextFieldBuilder labelTextField3Builder = new LabelTextFieldBuilder("Resultado", 25, 80);
    ...
    AbstractAction action = new AbstractAction("Calcular") {
			...
			public void actionPerformed(ActionEvent e) {
				float resultado = Calculos.aplicacaoDesconto(Float.parseFloat(labelTextFieldBuilder.GetTextField().getText().toString()),
