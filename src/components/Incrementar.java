...
public class Incrementar extends JPanel {
  ...
  public Incrementar() {
    _painel = new JPanel();
    _painel.setBorder(BorderFactory.createTitledBorder("Incrementar % a um valor"));
    _painel.setLayout(null);
    _painel.setBounds(305, 5, 300, 150);

    LabelTextFieldBuilder labelTextFieldBuilder = new LabelTextFieldBuilder("Valor inicial R$ %", 25, 20);
    labelTextFieldBuilder.Build(_painel);

    LabelTextFieldBuilder labelTextField2Builder = new LabelTextFieldBuilder("Acréscimo %", 25, 50);
