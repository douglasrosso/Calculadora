...
public class Amostragem1 extends JPanel {
   private JPanel _painel;

  public Amostragem1() {
    _painel = new JPanel();
    _painel.setBorder(BorderFactory.createTitledBorder("Amostragem - Quanto X% representa de Y"));
    _painel.setLayout(null);
    _painel.setBounds(605, 5, 300, 150);

    LabelTextFieldBuilder labelTextFieldBuilder = new LabelTextFieldBuilder("Total (a)", 25, 20);
    labelTextFieldBuilder.Build(_painel);

    LabelTextFieldBuilder labelTextField2Builder = new LabelTextFieldBuilder("Porcentagem (b)", 25, 50);
    labelTextField2Builder.Build(_painel);

    LabelTextFieldBuilder labelTextField3Builder = new LabelTextFieldBuilder("Corresponde a", 25, 80);
