...
public class RegraD3 extends JPanel {
  ...
  public RegraD3() {
    ...
    // float resultado =
    // calculos.regraDeTres(Float.parseFloat(txfRegra1.getText().toString()),
    ...
    // painelRegraDeTres.add(btnCalcular);

    // getContentPane().add(painelRegraDeTres);
    _painel = new JPanel();
